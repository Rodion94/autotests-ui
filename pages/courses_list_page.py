...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_estimated_menu_time_text = page.get_by_test_id('course-estimated-time-info-row-view-text')
    ...
    def check_visible_course_card(
        ...
        expect(self.course_estimated_menu_time_text.nth(index)).to_be_visible()
        expect(self.course_estimated_menu_time_text.nth(index)).to_have_text(f"Estimated time: {estimated_time}")
